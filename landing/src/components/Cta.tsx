    ...
    <section className="mx-auto max-w-6xl px-5 py-20">
      <Reveal>
        <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[var(--brand-500)] to-[var(--accent-600)] px-8 py-16 text-center sm:px-16">
          ...
          <a
            href={REGISTER_URL}
            className="relative mt-8 inline-flex items-center gap-2 rounded-full bg-white text-[var(--accent-600)] font-semibold px-7 py-3.5 shadow-lg hover:shadow-xl hover:scale-[1.03] transition-all"
          >
            {t('ctaButton')}
