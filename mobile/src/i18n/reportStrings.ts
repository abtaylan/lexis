// src/i18n/reportStrings.ts — web'deki lib/reportLocale.ts ile birebir aynı
// çeviriler (10 dilin hepsi). app/(app)/report.tsx için. İstatistik &
// Raporlama V2 öncelik #3, madde A — "Raporum" ekranı.
import type { Locale } from './locales';

export type ReportStrings = {
  title: string; subtitle: string;
  weekTab: string; monthTab: string;
  loading: string; error: string; retryBtn: string;
  newLabel: string;
  sectionStudy: string; minutesLabel: string; sessionsLabel: string;
  sectionStreak: string; currentStreakLabel: string; longestStreakLabel: string; streakUnit: string;
  sectionVocabulary: string; totalWordsLabel: string; learnedWordsLabel: string; newWordsLabel: string;
  sectionGames: string; gameSessionsLabel: string; avgScoreLabel: string;
  sectionExam: string; accuracyLabel: string; weakTopicsLabel: string; strongTopicsLabel: string;
  noTopicDataLabel: string; attemptsUnit: string;
  sectionQuests: string; questsCompletedLabel: string; questsProgressLabel: string;
  sectionBadges: string; badgesTotalLabel: string; badgesNewLabel: string;
  sectionLeague: string; currentTierLabel: string; leagueHistoryLabel: string; noLeagueHistoryLabel: string;
  outcomePromoted: string; outcomeDemoted: string; outcomeStayed: string;
  sectionSubscription: string; premiumActiveLabel: string; premiumUntilTpl: string; freeLabel: string; noTierLabel: string;
  sectionPlatform: string; platformAvgMinutesLabel: string; platformAvgNewWordsLabel: string;
  platformAvgAccuracyLabel: string; platformXpPercentileLabel: string; percentileUnit: string;
  noPlatformDataLabel: string; sameCountryNoteLabel: string;
  exportFormatCsv: string; exportFormatXlsx: string; exportFormatPdf: string;
  exportDownloadBtn: string; exportEmailBtn: string;
  exportDownloading: string; exportSending: string;
  exportSentToTpl: string; exportErrorMsg: string;
};

export const REPORT_STRINGS: Record<Locale, ReportStrings> = {
  tr: {
