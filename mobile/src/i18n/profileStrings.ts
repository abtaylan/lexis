...
export const PROFILE_STRINGS: Record<Locale, ProfileStrings> = {
  ...
  pt: {
    back: 'Amigos', notFound: 'Este utilizador não foi encontrado.', error: 'Não foi possível carregar o perfil.',
    ...
    removeFriendBtn: 'Remover amigo', removeConfirm: 'Tens a certeza de que queres remover esta pessoa dos teus amigos?',
    ...
    streakLabel: 'Sequência atual', streakUnit: 'dias', scheduleTitle: 'Plano de estudo', scheduleEmpty: 'Não há nenhum plano de estudo ativo.',
    actionError: 'A ação falhou.', levelPrefix: 'Nív.', minLabel: 'min',
    days: 'Dom,Seg,Ter,Qua,Qui,Sex,Sáb',
    messageBtn: 'Enviar mensagem', blockBtn: 'Bloquear',
    blockConfirm: 'Tens a certeza de que queres bloquear esta pessoa? Deixarão de poder ver as mensagens, o perfil e os pedidos de amizade/seguimento um do outro.',
    blockError: 'Não foi possível bloquear este utilizador.',
    reportBtn: 'Denunciar', reportConfirm: 'Tens a certeza de que queres denunciar este utilizador por comportamento inadequado? A nossa equipa irá analisar.',
    reportSuccess: 'A tua denúncia foi recebida, obrigado.', reportError: 'Não foi possível enviar a denúncia.',
  },
};
