...
export interface ReportStrings {
  ...
  platformAvgMinutesLabel: string;
  platformAvgNewWordsLabel: string;
  platformAvgAccuracyLabel: string;
  platformXpPercentileLabel: string;
...
export const REPORT_L: Record<Locale, ReportStrings> = {
  tr: {
    ...
    sectionPlatform: 'Platform Karşılaştırması',
    platformAvgMinutesLabel: 'Platform ortalaması (dakika)',
    platformAvgNewWordsLabel: 'Platform ortalaması (yeni kelime)',
    platformAvgAccuracyLabel: 'Platform ortalama doğruluk',
    platformXpPercentileLabel: 'XP yüzdelik dilimin',
  ...
  en: {
    ...
    sectionPlatform: 'Platform Comparison',
    platformAvgMinutesLabel: 'Platform average (minutes)',
    platformAvgNewWordsLabel: 'Platform average (new words)',
    platformAvgAccuracyLabel: 'Platform average accuracy',
    platformXpPercentileLabel: 'Your XP percentile',
  ...
  de: {
    ...
    sectionPlatform: 'Plattformvergleich',
    platformAvgMinutesLabel: 'Plattformdurchschnitt (Minuten)',
    platformAvgNewWordsLabel: 'Plattformdurchschnitt (neue Wörter)',
    platformAvgAccuracyLabel: 'Durchschnittliche Genauigkeit der Plattform',
    platformXpPercentileLabel: 'Dein XP-Perzentil',
  ...
  fr: {
    ...
    sectionPlatform: 'Comparaison avec la plateforme',
    platformAvgMinutesLabel: 'Moyenne de la plateforme (minutes)',
    platformAvgNewWordsLabel: 'Moyenne de la plateforme (nouveaux mots)',
    platformAvgAccuracyLabel: 'Précision moyenne de la plateforme',
    platformXpPercentileLabel: 'Ton percentile XP',
    percentileUnit: 'percentile',
  ...
  es: {
    ...
    sectionPlatform: 'Comparación con la plataforma',
    platformAvgMinutesLabel: 'Media de la plataforma (minutos)',
    platformAvgNewWordsLabel: 'Media de la plataforma (palabras nuevas)',
    platformAvgAccuracyLabel: 'Precisión media de la plataforma',
    platformXpPercentileLabel: 'Tu percentil de XP',
  ...
  it: {
    ...
    sectionPlatform: 'Confronto con la piattaforma',
    platformAvgMinutesLabel: 'Media della piattaforma (minuti)',
    platformAvgNewWordsLabel: 'Media della piattaforma (nuove parole)',
    platformAvgAccuracyLabel: 'Precisione media della piattaforma',
    platformXpPercentileLabel: 'Il tuo percentile XP',
    percentileUnit: 'percentile',
  ...
  ar: {
    ...
    sectionPlatform: 'مقارنة مع المنصة',
    platformAvgMinutesLabel: 'متوسط المنصة (دقائق)',
    platformAvgNewWordsLabel: 'متوسط المنصة (كلمات جديدة)',
    platformAvgAccuracyLabel: 'متوسط دقة المنصة',
    platformXpPercentileLabel: 'شريحتك المئوية من نقاط الخبرة',
  ...
  ru: {
    ...
    sectionPlatform: 'Сравнение с платформой',
    platformAvgMinutesLabel: 'Средний показатель платформы (минуты)',
    platformAvgNewWordsLabel: 'Средний показатель платформы (новые слова)',
    platformAvgAccuracyLabel: 'Средняя точность на платформе',
    platformXpPercentileLabel: 'Твой процентиль по опыту (XP)',
  ...
  ja: {
    ...
    sectionPlatform: 'プラットフォーム比較',
    platformAvgMinutesLabel: 'プラットフォーム平均(分)',
    platformAvgNewWordsLabel: 'プラットフォーム平均(新規単語数)',
    platformAvgAccuracyLabel: 'プラットフォーム平均正答率',
    platformXpPercentileLabel: 'あなたのXPパーセンタイル',
  ...
  pt: {
    ...
    sectionPlatform: 'Comparação com a Plataforma',
    platformAvgMinutesLabel: 'Média da plataforma (minutos)',
    platformAvgNewWordsLabel: 'Média da plataforma (novas palavras)',
    platformAvgAccuracyLabel: 'Precisão média da plataforma',
    platformXpPercentileLabel: 'O teu percentil de XP',
    percentileUnit: 'percentil',
