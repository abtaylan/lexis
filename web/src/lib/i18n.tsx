...
| 'correctLabel' | 'wrongLabel' | 'successRate' | 'restartBtn' | 'wordsLoadError' | 'greatJob' | 'noWordsDue' | 'noWordsYetTitle' | 'noWordsYetSubtitle'
| 'tapToFlip' | 'listenBtn' | 'exampleHeader' | 'dontKnowBtn' | 'knewItBtn' | 'correctCountTpl' | 'wrongCountTpl'
...
| 'weekdayLabels'
| 'exportPdfBtn' | 'exportModalTitle' | 'exportModalDesc' | 'exportEmptyMsg' | 'exportGeneratingBtn' | 'exportDownloadBtn' | 'exportPdfFailed'
...
| 'haveAccountQuestion' | 'loginLinkText' | 'forgotPasswordLink' | 'sessionExpiredNotice' | 'backToPageBtn'
...
noWordsDue: 'Bugün için tekrar edilecek kelimen yok.', noWordsYetTitle: 'Henüz kelimen yok', noWordsYetSubtitle: 'Kartlarla çalışmak için önce birkaç kelime ekle ya da bir oyun oyna — doğru bildiğin kelimeler otomatik olarak hazineye eklenir.', tapToFlip: 'Çevirmek için tıkla', listenBtn: 'Dinle', exampleHeader: 'Örnek',
...
exportPdfBtn: 'PDF İndir', exportModalTitle: 'Programı PDF Olarak İndir',
exportModalDesc: 'Bir tasarım seç — çıktıyı yazdırıp masana koyabilir veya bir yere asabilirsin.',
exportEmptyMsg: 'Önce bir çalışma programı oluştur (şablon uygula ya da elle etkinlik ekle), sonra PDF çıktısı alabilirsin.',
exportGeneratingBtn: 'Oluşturuluyor…', exportDownloadBtn: 'PDF İndir', exportPdfFailed: 'PDF oluşturulamadı, lütfen tekrar deneyin.',
...
createAccountBtn: 'Hesap Oluştur', haveAccountQuestion: 'Zaten hesabın var mı?', loginLinkText: 'Giriş yap', forgotPasswordLink: 'Şifremi unuttum?', sessionExpiredNotice: 'Oturumunuz sona ermiş görünüyor.', backToPageBtn: 'Kaldığınız sayfaya dön',
...
myLanguagesTitle: 'Dillerim', addLanguageBtn: 'Dil Ekle', addLanguageModalTitle: 'Öğrenme Dili Ekle', selectLanguageLabel: 'Dil seç',
setActiveBtn: 'Aktif Yap', activeBadgeLabel: 'Aktif', removeLanguageBtn: 'Kaldır', removeLanguageConfirm: 'Bu dili listenden kaldırmak istediğine emin misin?',
cannotRemoveActiveLanguageError: 'Aktif dili kaldıramazsın. Önce başka bir dili aktif yap.', languageAlreadyAddedError: 'Bu dil zaten listende.',
...
premiumPageSubtitle: 'Reklamsız, sınırsız kelime öğrenme deneyimi', premiumPlansLoadError: 'Plan bilgileri alınamadı.',
premiumCheckoutFormError: 'Ödeme formu oluşturulamadı.', premiumCheckoutStartError: 'Ödeme başlatılamadı, lütfen tekrar deneyin.',
premiumCancelConfirm: 'Aboneliğini iptal etmek istediğine emin misin? Dönem sonuna kadar premium erişimin devam eder.',
premiumCancelError: 'Abonelik iptal edilemedi.', premiumSuccessMsg: 'Ödemen alındı, premium üyeliğin aktifleşti 🎉',
premiumFailedMsg: 'Ödeme tamamlanamadı. Tekrar deneyebilirsin.', premiumPeriodEndTpl: 'Dönem sonu: {date}',
...
noWordsDue: 'You have no words due for review today.', noWordsYetTitle: 'You don\'t have any words yet', noWordsYetSubtitle: 'Add a few words or play a game first — words you get right are added to your treasury automatically.', tapToFlip: 'Tap to flip', listenBtn: 'Listen', exampleHeader: 'Example',
...
exportPdfBtn: 'Download PDF', exportModalTitle: 'Download Schedule as PDF',
exportModalDesc: 'Pick a design — print it and keep it on your desk or pin it up somewhere.',
exportEmptyMsg: 'Create a study schedule first (apply a template or add an activity manually), then you can export it as a PDF.',
exportGeneratingBtn: 'Generating…', exportDownloadBtn: 'Download PDF', exportPdfFailed: 'Could not generate the PDF, please try again.',
...
createAccountBtn: 'Create Account', haveAccountQuestion: 'Already have an account?', loginLinkText: 'Log in', forgotPasswordLink: 'Forgot password?', sessionExpiredNotice: 'It looks like your session expired.', backToPageBtn: 'Back to your page',
...
myLanguagesTitle: 'My Languages', addLanguageBtn: 'Add Language', addLanguageModalTitle: 'Add Learning Language', selectLanguageLabel: 'Select language',
setActiveBtn: 'Set Active', activeBadgeLabel: 'Active', removeLanguageBtn: 'Remove', removeLanguageConfirm: 'Are you sure you want to remove this language from your list?',
cannotRemoveActiveLanguageError: 'You cannot remove the active language. Set another language as active first.', languageAlreadyAddedError: 'This language is already in your list.',
...
premiumPageSubtitle: 'An ad-free, unlimited vocabulary learning experience', premiumPlansLoadError: 'Could not load plan information.',
premiumCheckoutFormError: 'Could not create payment form.', premiumCheckoutStartError: 'Could not start payment, please try again.',
premiumCancelConfirm: 'Are you sure you want to cancel your subscription? Your premium access continues until the end of the period.',
premiumCancelError: 'Could not cancel subscription.', premiumSuccessMsg: 'Your payment was received, your premium membership is now active 🎉',
premiumFailedMsg: 'Payment could not be completed. You can try again.', premiumPeriodEndTpl: 'Period ends: {date}',
...
noWordsDue: 'لا توجد كلمات للمراجعة اليوم.', noWordsYetTitle: 'ليس لديك كلمات بعد', noWordsYetSubtitle: 'أضف بعض الكلمات أو العب إحدى الألعاب أولاً — الكلمات التي تجيب عنها بشكل صحيح تُضاف تلقائيًا إلى مخزونك.', tapToFlip: 'انقر للقلب', listenBtn: 'استمع', exampleHeader: 'مثال',
...
exportPdfBtn: 'تنزيل PDF', exportModalTitle: 'تنزيل البرنامج كملف PDF',
exportModalDesc: 'اختر تصميمًا — يمكنك طباعته والاحتفاظ به على مكتبك أو تعليقه في مكان ما.',
exportEmptyMsg: 'أنشئ برنامج دراسة أولاً (طبّق قالبًا أو أضف نشاطًا يدويًا)، ثم يمكنك تصديره كملف PDF.',
exportGeneratingBtn: 'جارٍ الإنشاء…', exportDownloadBtn: 'تنزيل PDF', exportPdfFailed: 'تعذر إنشاء ملف PDF، حاول مرة أخرى.',
...
createAccountBtn: 'إنشاء الحساب', haveAccountQuestion: 'لديك حساب بالفعل؟', loginLinkText: 'تسجيل الدخول', forgotPasswordLink: 'هل نسيت كلمة المرور؟', sessionExpiredNotice: 'يبدو أن جلستك قد انتهت.', backToPageBtn: 'العودة إلى صفحتك',
...
myLanguagesTitle: 'لغاتي', addLanguageBtn: 'إضافة لغة', addLanguageModalTitle: 'إضافة لغة تعلم', selectLanguageLabel: 'اختر لغة',
setActiveBtn: 'تعيين كنشطة', activeBadgeLabel: 'نشطة', removeLanguageBtn: 'إزالة', removeLanguageConfirm: 'هل أنت متأكد من إزالة هذه اللغة من قائمتك؟',
cannotRemoveActiveLanguageError: 'لا يمكنك إزالة اللغة النشطة. فعّل لغة أخرى أولاً.', languageAlreadyAddedError: 'هذه اللغة موجودة بالفعل في قائمتك.',
...
premiumPageSubtitle: 'تجربة تعلم مفردات غير محدودة وخالية من الإعلانات', premiumPlansLoadError: 'تعذر تحميل معلومات الخطة.',
premiumCheckoutFormError: 'تعذر إنشاء نموذج الدفع.', premiumCheckoutStartError: 'تعذر بدء عملية الدفع، يرجى المحاولة مرة أخرى.',
premiumCancelConfirm: 'هل أنت متأكد أنك تريد إلغاء اشتراكك؟ سيستمر وصولك إلى بريميوم حتى نهاية الفترة.',
premiumCancelError: 'تعذر إلغاء الاشتراك.', premiumSuccessMsg: 'تم استلام دفعتك، عضويتك المميزة نشطة الآن 🎉',
premiumFailedMsg: 'تعذر إتمام الدفع. يمكنك المحاولة مرة أخرى.', premiumPeriodEndTpl: 'نهاية الفترة: {date}',
...
noWordsDue: 'На сегодня нет слов для повторения.', noWordsYetTitle: 'У вас пока нет слов', noWordsYetSubtitle: 'Сначала добавьте несколько слов или сыграйте в игру — слова, которые вы угадаете правильно, автоматически добавляются в вашу коллекцию.', tapToFlip: 'Нажми, чтобы перевернуть', listenBtn: 'Слушать', exampleHeader: 'Пример',
...
exportPdfBtn: 'Скачать PDF', exportModalTitle: 'Скачать расписание в PDF',
exportModalDesc: 'Выберите дизайн — распечатайте и держите на столе или повесьте на стену.',
exportEmptyMsg: 'Сначала создайте учебное расписание (примените шаблон или добавьте занятие вручную), затем вы можете экспортировать его в PDF.',
exportGeneratingBtn: 'Создание…', exportDownloadBtn: 'Скачать PDF', exportPdfFailed: 'Не удалось создать PDF, попробуйте снова.',
...
createAccountBtn: 'Создать аккаунт', haveAccountQuestion: 'Уже есть аккаунт?', loginLinkText: 'Войти', forgotPasswordLink: 'Забыли пароль?', sessionExpiredNotice: 'Похоже, ваша сессия истекла.', backToPageBtn: 'Вернуться на страницу',
...
myLanguagesTitle: 'Мои языки', addLanguageBtn: 'Добавить язык', addLanguageModalTitle: 'Добавить изучаемый язык', selectLanguageLabel: 'Выберите язык',
setActiveBtn: 'Сделать активным', activeBadgeLabel: 'Активный', removeLanguageBtn: 'Удалить', removeLanguageConfirm: 'Уверены, что хотите удалить этот язык из списка?',
cannotRemoveActiveLanguageError: 'Нельзя удалить активный язык. Сначала сделайте активным другой язык.', languageAlreadyAddedError: 'Этот язык уже в твоём списке.',
...
premiumPageSubtitle: 'Изучение слов без рекламы и без ограничений', premiumPlansLoadError: 'Не удалось загрузить информацию о планах.',
premiumCheckoutFormError: 'Не удалось создать форму оплаты.', premiumCheckoutStartError: 'Не удалось начать оплату, попробуйте снова.',
premiumCancelConfirm: 'Вы уверены, что хотите отменить подписку? Premium-доступ сохранится до конца периода.',
premiumCancelError: 'Не удалось отменить подписку.', premiumSuccessMsg: 'Оплата получена, ваше Premium-членство активировано 🎉',
premiumFailedMsg: 'Оплату не удалось завершить. Вы можете попробовать снова.', premiumPeriodEndTpl: 'Окончание периода: {date}',
...
noWordsDue: 'Heute sind keine Wörter zur Wiederholung fällig.', noWordsYetTitle: 'Du hast noch keine Wörter', noWordsYetSubtitle: 'Füge zuerst ein paar Wörter hinzu oder spiele ein Spiel — richtig erkannte Wörter werden automatisch zu deinem Wortschatz hinzugefügt.', tapToFlip: 'Zum Umdrehen tippen', listenBtn: 'Anhören', exampleHeader: 'Beispiel',
...
exportPdfBtn: 'PDF herunterladen', exportModalTitle: 'Stundenplan als PDF herunterladen',
exportModalDesc: 'Wähle ein Design – drucke es aus und lege es auf deinen Schreibtisch oder hänge es irgendwo auf.',
exportEmptyMsg: 'Erstelle zuerst einen Stundenplan (wende eine Vorlage an oder füge eine Aktivität manuell hinzu), danach kannst du ihn als PDF exportieren.',
exportGeneratingBtn: 'Wird erstellt…', exportDownloadBtn: 'PDF herunterladen', exportPdfFailed: 'PDF konnte nicht erstellt werden, bitte versuche es erneut.',
...
createAccountBtn: 'Konto erstellen', haveAccountQuestion: 'Bereits ein Konto?', loginLinkText: 'Anmelden', forgotPasswordLink: 'Passwort vergessen?', sessionExpiredNotice: 'Deine Sitzung scheint abgelaufen zu sein.', backToPageBtn: 'Zurück zur Seite',
...
myLanguagesTitle: 'Meine Sprachen', addLanguageBtn: 'Sprache hinzufügen', addLanguageModalTitle: 'Lernsprache hinzufügen', selectLanguageLabel: 'Sprache auswählen',
setActiveBtn: 'Aktivieren', activeBadgeLabel: 'Aktiv', removeLanguageBtn: 'Entfernen', removeLanguageConfirm: 'Möchtest du diese Sprache wirklich aus deiner Liste entfernen?',
cannotRemoveActiveLanguageError: 'Du kannst die aktive Sprache nicht entfernen. Aktiviere zuerst eine andere Sprache.', languageAlreadyAddedError: 'Diese Sprache ist bereits in deiner Liste.',
...
premiumPageSubtitle: 'Werbefreies, unbegrenztes Vokabellernen', premiumPlansLoadError: 'Plan-Informationen konnten nicht geladen werden.',
premiumCheckoutFormError: 'Zahlungsformular konnte nicht erstellt werden.', premiumCheckoutStartError: 'Zahlung konnte nicht gestartet werden, bitte versuche es erneut.',
premiumCancelConfirm: 'Möchtest du dein Abo wirklich kündigen? Dein Premium-Zugang bleibt bis zum Ende des Zeitraums bestehen.',
premiumCancelError: 'Abo konnte nicht gekündigt werden.', premiumSuccessMsg: 'Deine Zahlung ist eingegangen, deine Premium-Mitgliedschaft ist jetzt aktiv 🎉',
premiumFailedMsg: 'Zahlung konnte nicht abgeschlossen werden. Du kannst es erneut versuchen.', premiumPeriodEndTpl: 'Ende des Zeitraums: {date}',
...
noWordsDue: "Tu n'as aucun mot à réviser aujourd'hui.", noWordsYetTitle: 'Tu n\'as pas encore de mots', noWordsYetSubtitle: 'Ajoute quelques mots ou joue à un jeu d\'abord — les mots que tu trouves juste sont ajoutés automatiquement à ton trésor.', tapToFlip: 'Touche pour retourner', listenBtn: 'Écouter', exampleHeader: 'Exemple',
...
exportPdfBtn: 'Télécharger le PDF', exportModalTitle: 'Télécharger le programme en PDF',
exportModalDesc: 'Choisissez un modèle — imprimez-le et gardez-le sur votre bureau ou affichez-le quelque part.',
exportEmptyMsg: 'Créez d’abord un programme d’étude (appliquez un modèle ou ajoutez une activité manuellement), puis vous pourrez l’exporter en PDF.',
exportGeneratingBtn: 'Génération…', exportDownloadBtn: 'Télécharger le PDF', exportPdfFailed: 'Impossible de générer le PDF, veuillez réessayer.',
...
createAccountBtn: 'Créer le compte', haveAccountQuestion: 'Déjà un compte ?', loginLinkText: 'Se connecter', forgotPasswordLink: 'Mot de passe oublié ?', sessionExpiredNotice: 'Il semble que votre session ait expiré.', backToPageBtn: 'Retour à la page',
...
myLanguagesTitle: 'Mes langues', addLanguageBtn: 'Ajouter une langue', addLanguageModalTitle: "Ajouter une langue d'apprentissage", selectLanguageLabel: 'Choisir une langue',
setActiveBtn: 'Définir comme active', activeBadgeLabel: 'Active', removeLanguageBtn: 'Supprimer', removeLanguageConfirm: 'Es-tu sûr de vouloir supprimer cette langue de ta liste ?',
cannotRemoveActiveLanguageError: "Tu ne peux pas supprimer la langue active. Active d'abord une autre langue.", languageAlreadyAddedError: 'Cette langue est déjà dans ta liste.',
...
premiumPageSubtitle: 'Un apprentissage du vocabulaire sans publicité et illimité', premiumPlansLoadError: 'Impossible de charger les informations sur les forfaits.',
premiumCheckoutFormError: 'Impossible de créer le formulaire de paiement.', premiumCheckoutStartError: 'Impossible de démarrer le paiement, veuillez réessayer.',
premiumCancelConfirm: 'Es-tu sûr de vouloir annuler ton abonnement ? Ton accès premium continue jusqu’à la fin de la période.',
premiumCancelError: 'Impossible d’annuler l’abonnement.', premiumSuccessMsg: 'Ton paiement a été reçu, ton abonnement premium est maintenant actif 🎉',
premiumFailedMsg: 'Le paiement n’a pas pu être finalisé. Tu peux réessayer.', premiumPeriodEndTpl: 'Fin de la période : {date}',
...
noWordsDue: 'No tienes palabras para repasar hoy.', noWordsYetTitle: 'Todavía no tienes palabras', noWordsYetSubtitle: 'Añade algunas palabras o juega primero — las palabras que aciertas se añaden automáticamente a tu tesoro.', tapToFlip: 'Toca para voltear', listenBtn: 'Escuchar', exampleHeader: 'Ejemplo',
...
exportPdfBtn: 'Descargar PDF', exportModalTitle: 'Descargar el programa en PDF',
exportModalDesc: 'Elige un diseño — imprímelo y tenlo en tu escritorio o cuélgalo en algún lugar.',
exportEmptyMsg: 'Primero crea un programa de estudio (aplica una plantilla o añade una actividad manualmente), luego podrás exportarlo como PDF.',
exportGeneratingBtn: 'Generando…', exportDownloadBtn: 'Descargar PDF', exportPdfFailed: 'No se pudo generar el PDF, inténtalo de nuevo.',
...
createAccountBtn: 'Crear cuenta', haveAccountQuestion: '¿Ya tienes cuenta?', loginLinkText: 'Iniciar sesión', forgotPasswordLink: '¿Olvidaste tu contraseña?', sessionExpiredNotice: 'Parece que tu sesión ha expirado.', backToPageBtn: 'Volver a la página',
...
myLanguagesTitle: 'Mis idiomas', addLanguageBtn: 'Añadir idioma', addLanguageModalTitle: 'Añadir idioma de aprendizaje', selectLanguageLabel: 'Selecciona un idioma',
setActiveBtn: 'Activar', activeBadgeLabel: 'Activo', removeLanguageBtn: 'Eliminar', removeLanguageConfirm: '¿Seguro que quieres eliminar este idioma de tu lista?',
cannotRemoveActiveLanguageError: 'No puedes eliminar el idioma activo. Activa antes otro idioma.', languageAlreadyAddedError: 'Este idioma ya está en tu lista.',
...
premiumPageSubtitle: 'Aprendizaje de vocabulario sin anuncios e ilimitado', premiumPlansLoadError: 'No se pudo cargar la información de los planes.',
premiumCheckoutFormError: 'No se pudo crear el formulario de pago.', premiumCheckoutStartError: 'No se pudo iniciar el pago, inténtalo de nuevo.',
premiumCancelConfirm: '¿Seguro que quieres cancelar tu suscripción? Tu acceso premium continuará hasta el final del período.',
premiumCancelError: 'No se pudo cancelar la suscripción.', premiumSuccessMsg: 'Tu pago fue recibido, tu membresía premium ya está activa 🎉',
premiumFailedMsg: 'No se pudo completar el pago. Puedes intentarlo de nuevo.', premiumPeriodEndTpl: 'Fin del período: {date}',
...
noWordsDue: 'Non hai parole da ripassare oggi.', noWordsYetTitle: 'Non hai ancora parole', noWordsYetSubtitle: 'Aggiungi prima qualche parola o gioca — le parole che indovini vengono aggiunte automaticamente al tuo tesoro.', tapToFlip: 'Tocca per girare', listenBtn: 'Ascolta', exampleHeader: 'Esempio',
...
exportPdfBtn: 'Scarica PDF', exportModalTitle: 'Scarica il programma in PDF',
exportModalDesc: 'Scegli un design — stampalo e tienilo sulla scrivania o attaccalo da qualche parte.',
exportEmptyMsg: 'Crea prima un programma di studio (applica un modello o aggiungi un’attività manualmente), poi potrai esportarlo in PDF.',
exportGeneratingBtn: 'Generazione…', exportDownloadBtn: 'Scarica PDF', exportPdfFailed: 'Impossibile generare il PDF, riprova.',
...
createAccountBtn: 'Crea account', haveAccountQuestion: 'Hai già un account?', loginLinkText: 'Accedi', forgotPasswordLink: 'Password dimenticata?', sessionExpiredNotice: 'Sembra che la tua sessione sia scaduta.', backToPageBtn: 'Torna alla pagina',
...
myLanguagesTitle: 'Le mie lingue', addLanguageBtn: 'Aggiungi lingua', addLanguageModalTitle: 'Aggiungi lingua di apprendimento', selectLanguageLabel: 'Seleziona lingua',
setActiveBtn: 'Imposta come attiva', activeBadgeLabel: 'Attiva', removeLanguageBtn: 'Rimuovi', removeLanguageConfirm: 'Sei sicuro di voler rimuovere questa lingua dalla tua lista?',
cannotRemoveActiveLanguageError: 'Non puoi rimuovere la lingua attiva. Attiva prima un’altra lingua.', languageAlreadyAddedError: 'Questa lingua è già nella tua lista.',
...
premiumPageSubtitle: 'Apprendimento del vocabolario senza pubblicità e illimitato', premiumPlansLoadError: 'Impossibile caricare le informazioni sui piani.',
premiumCheckoutFormError: 'Impossibile creare il modulo di pagamento.', premiumCheckoutStartError: 'Impossibile avviare il pagamento, riprova.',
premiumCancelConfirm: 'Sei sicuro di voler annullare il tuo abbonamento? Il tuo accesso premium continuerà fino alla fine del periodo.',
premiumCancelError: 'Impossibile annullare l’abbonamento.', premiumSuccessMsg: 'Il tuo pagamento è stato ricevuto, il tuo abbonamento premium è ora attivo 🎉',
premiumFailedMsg: 'Il pagamento non è stato completato. Puoi riprovare.', premiumPeriodEndTpl: 'Fine periodo: {date}',
...
thisWeekColon: '今週', lastWeekColon: '先週', flashcardPractice: 'フラッシュカード練習', cardsWaitingLabel: '枚のカードが待機中',
startQuiz: 'クイズを始める', testKnowledge: '知識をテストしよう', addWord: '単語を追加', expandList: 'リストを増やそう', levelDistribution: 'レベル分布',
newLabel: '新規', learningLabel: '学習中', learnedLabel: '習得済み', recentWordsTitle: '最近追加した単語', noWordsYet: 'まだ単語が追加されていません。',
newBadge: '新規', dueTimeLabel: '語の復習時期です', startBtn: '開始', dayLabels: '月,火,水,木,金,土,日',
statusLearned: '習得済み', statusLearning: '学習中', statusArchived: 'アーカイブ', lookupNoMeaning: '意味が見つかりませんでした。手動で入力できます。',
lookupNotFound: '辞書に見つかりませんでした。手動で入力できます。', lookupApplied: '✓ 意味をフォームに追加しました。編集できます。', meaningRequired: '単語と意味は必須です。',
saveFailed: '保存できませんでした。もう一度お試しください。', meaningRequiredLabel: '意味 *', meaningNativeTpl: '{lang}での意味', meaningTargetTpl: '{lang}での説明',
exampleLabel: '例文', wordTypeLabel: '品詞', wordRequiredLabel: '単語 *', searchBtn: '検索', searchTooltip: '辞書を検索',
lookupHelper: '単語を入力してEnterキーを押すか「検索」をクリックすると、意味が自動的に入力されます。', meaningsFoundTpl: '「{word}」に{n}件の意味が見つかりました — 選択してください：',
listLabel: 'リスト', listActive: 'アクティブ', listPassive: 'パッシブ', cancelBtn: 'キャンセル', savingBtn: '保存中…', saveBtn: '保存',
totalWordsCountTpl: '合計{n}語', addWordBtn: '単語を追加', learnedWordsLabel: '習得済み', archivedWordsLabel: 'アーカイブ済み',
searchPlaceholder: '単語を検索…', allStatuses: 'すべての状態', allLists: 'すべてのリスト', statusArchivedOption: 'アーカイブ済み',
noWordsFound: '単語が見つかりません', noWordsFoundSub: 'フィルターを変更するか、新しい単語を追加してください。', colWord: '単語', colMeaning: '意味',
colType: '品詞', colStatus: '状態', colRepeat: '復習回数', colNext: '次回', deleteWordConfirm: 'この単語を削除してもよろしいですか？',
paginationTpl: '{n}語 · {pages}ページ中{page}ページ目', prevPage: '← 前へ', nextPage: '次へ →', addWordModalTitle: '新しい単語を追加', editWordModalTitle: '単語を編集',
sessionComplete: 'セッション完了！', reviewedCountTpl: '{n}語を復習しました', correctLabel: '正解', wrongLabel: '不正解',
successRate: '正解率', restartBtn: '再開', wordsLoadError: '単語を読み込めませんでした。', greatJob: 'よくできました！',
noWordsDue: '今日復習する単語はありません。', noWordsYetTitle: 'まだ単語がありません', noWordsYetSubtitle: 'まず単語を追加するかゲームをプレイしてください — 正解した単語は自動的にあなたの単語帳に追加されます。', tapToFlip: 'タップして裏返す', listenBtn: '聞く', exampleHeader: '例文',
dontKnowBtn: '知らなかった', knewItBtn: '知っていた', correctCountTpl: '正解{n}問', wrongCountTpl: '不正解{n}問',
tierExcellent: '素晴らしい！', tierGood: 'よくできました！', tierKeepGoing: 'その調子！', questionsCompletedTpl: '{n}問完了しました',
retryQuizBtn: 'クイズをやり直す', quizMinWordsError: 'クイズには最低4つの単語が必要です。まずいくつか単語を追加してください。',
quizQuestionPrompt: 'この単語の意味は？', questionCounterTpl: '問題 {i}/{n}',
scheduleTitle: '学習スケジュール', activeDaysStatsTpl: '活動日{days}日 · {items}件のアクティビティ',
saveAsTemplateBtn: 'テンプレートとして保存', templatesBtn: 'テンプレート', addActivityBtn: 'アクティビティを追加', manualAddBtn: '手動で追加',
chooseTemplateBtn: 'テンプレートを選択', noScheduleYet: 'まだスケジュールがありません', noScheduleYetSub: '用意されたテンプレートですぐに始めるか、独自のアクティビティを追加してください。',
noActivity: 'アクティビティなし', toggleTooltip: '切り替え', deleteScheduleConfirm: 'このスケジュール項目を削除してもよろしいですか？',
deleteTemplateConfirm: 'このカスタムテンプレートを削除してもよろしいですか？', templatesModalTitle: '既製のスケジュールテンプレート',
templatesModalDesc: '学習頻度や重点分野に応じてテンプレートを選択すると、スケジュールが自動的に作成されます。その後、自由に編集できます。',
replaceExistingLabel: '現在のスケジュールを削除してテンプレートに置き換える', perWeekTpl: '週{n}件のアクティビティ', applyBtn: '適用',
myTemplatesLabel: 'マイテンプレート', noCustomTemplates: 'まだ自分のテンプレートがありません。スケジュールを作成し、「テンプレートとして保存」でここに保存できます。',
deleteTemplateTooltip: 'テンプレートを削除', addActivityModalTitle: 'アクティビティを追加', dayLabel: '曜日', timeLabel: '時間',
durationLabel: '所要時間（分）', activityLabel: 'アクティビティ *', linkLabel: 'リンク（任意）', activityRequired: 'アクティビティは必須です。',
saveScheduleFailed: '保存できませんでした。', saveTemplateModalTitle: 'テンプレートとして保存',
saveTemplateDesc: '現在のスケジュールを名前付きテンプレートとして保存し、いつでも再利用できます。',
templateNameLabel: 'テンプレート名 *', templateNameRequired: 'テンプレート名は必須です。', saveTemplateFailed: 'テンプレートを保存できませんでした。',
weekdayLabels: '日曜日,月曜日,火曜日,水曜日,木曜日,金曜日,土曜日',
exportPdfBtn: 'PDFをダウンロード', exportModalTitle: 'プログラムをPDFでダウンロード',
exportModalDesc: 'デザインを選んでください。印刷して机に置いたり、どこかに貼ったりできます。',
exportEmptyMsg: 'まず学習スケジュールを作成してください（テンプレートを適用するか、手動でアクティビティを追加）。その後PDFとして書き出せます。',
exportGeneratingBtn: '生成中…', exportDownloadBtn: 'PDFをダウンロード', exportPdfFailed: 'PDFを生成できませんでした。もう一度お試しください。',
brandHeadlineLine1: '最も賢い方法で', brandHeadlineLine2: '語彙を学ぼう',
brandSubtitle: '間隔反復学習で、最適なタイミングだけ復習。少ない学習でより多く身につく。',
statAlgorithmLabel: 'アルゴリズム', statLanguagesLabel: '対応言語', statLanguagesValue: '多言語対応',
statPlanLabel: 'プラン', statPlanValue: 'フリーミアム', copyrightTpl: '© {year} Lexis. All rights reserved.',
interfaceLanguageLabel: '表示言語',
loginTitle: 'Lexisにログイン', emailLabel: 'メールアドレス', passwordLabel: 'パスワード',
loginErrorMsg: 'ログインできませんでした。入力内容をご確認ください。', loggingInBtn: 'ログイン中…', loginBtnText: 'ログイン',
noAccountQuestion: 'アカウントをお持ちでない方', registerLinkText: '新規登録',
registerTitleText: 'アカウントを作成', registerSubtitleText: '数秒で始められます。',
fullNameLabel: '氏名', usernameLabel: 'ユーザー名', passwordHintText: '6文字以上',
nativeLangSelectLabel: '母語', learningLangSelectLabel: '学びたい言語',
emailInvalidError: '有効なメールアドレスを入力してください。', usernameMinError: '3文字以上で入力してください。', passwordMinError: '6文字以上で入力してください。',
sameLangError: '学びたい言語は母語と異なる必要があります。',
registerFailedGeneric: '登録に失敗しました。このメールアドレスは既に使用されている可能性があります。',
createAccountBtn: 'アカウントを作成', haveAccountQuestion: 'すでにアカウントをお持ちの方', loginLinkText: 'ログイン', forgotPasswordLink: 'パスワードをお忘れですか？', sessionExpiredNotice: 'セッションの有効期限が切れたようです。', backToPageBtn: '元のページに戻る',
typeNoun: '名詞', typeVerb: '動詞', typeAdjective: '形容詞', typeAdverb: '副詞', typePhrasalVerb: '句動詞', typeIdiom: 'イディオム', typePhrase: 'フレーズ', typeOther: 'その他',
statsLoadError: '統計を読み込めませんでした。', statsPageTitle: '統計', statsPageSubtitle: '学習の歩みが一目でわかる',
noDataYet: 'まだデータがありません', noDataYetSub: '単語を追加して学習を始めると、ここにグラフが表示されます。',
longestStreak: '最長連続記録', streakDaysAbbrTpl: '{n}日', statusDistribution: '状態別の分布', statusDistributionSub: '単語の学習状況',
learnedPercentLabel: '習得済み', typeByLearnRate: '品詞別の習得率', typeByLearnRateSub: 'どの品詞が得意？（%）',
learnRateTooltip: '習得率', typeDistribution: '品詞別の分布', typeDistributionSub: '品詞別の単語数', wordTooltip: '単語',
learningSpeed: '習得スピード', learningSpeedSub: '品詞別の平均復習回数 — 少ないほど速い', repeatUnitTpl: '{n}回復習', averageTooltip: '平均',
last30DaysTitle: '過去30日間 — 追加した単語', last30DaysSub: '日々の単語追加ペース', addedWordUnitTpl: '{n}語', addedTooltip: '追加',
studyActivity: '学習アクティビティ', studyActivitySub: '1日の追加数と復習数', addedLegend: '追加', repeatLegend: '復習',
profileLoadError: 'プロフィール情報を読み込めませんでした。', displayNameLabel: '表示名', emailChangeHint: 'メールアドレスを変更すると、Supabaseから確認メールが送信される場合があります。',
newPasswordLabel: '新しいパスワード', newPasswordPlaceholder: '変更しない場合は空欄のままにしてください', dailyGoalLabel: '1日の単語目標',
savedLabel: '保存しました', accountInfoTitle: 'アカウント情報', roleLabel: '役割', memberSinceLabel: '登録日',
myLanguagesTitle: 'マイ言語', addLanguageBtn: '言語を追加', addLanguageModalTitle: '学習言語を追加', selectLanguageLabel: '言語を選択',
setActiveBtn: 'アクティブに設定', activeBadgeLabel: 'アクティブ', removeLanguageBtn: '削除', removeLanguageConfirm: 'この言語をリストから削除してもよろしいですか？',
cannotRemoveActiveLanguageError: 'アクティブな言語は削除できません。先に別の言語をアクティブに設定してください。', languageAlreadyAddedError: 'この言語はすでにリストに追加されています。',
...
premiumPageSubtitle: '広告なし、無制限の単語学習体験', premiumPlansLoadError: 'プラン情報を取得できませんでした。',
premiumCheckoutFormError: '決済フォームを作成できませんでした。', premiumCheckoutStartError: '決済を開始できませんでした。もう一度お試しください。',
premiumCancelConfirm: '本当にサブスクリプションを解約しますか？プレミアムアクセスは期間終了まで継続されます。',
premiumCancelError: 'サブスクリプションを解約できませんでした。', premiumSuccessMsg: 'お支払いを確認しました。プレミアム会員が有効になりました 🎉',
premiumFailedMsg: '決済を完了できませんでした。もう一度お試しいただけます。', premiumPeriodEndTpl: '期間終了日: {date}',
...
todayAbbr: 'Hoje', thisWeekColon: 'Esta semana', lastWeekColon: 'Semana passada', flashcardPractice: 'Praticar cartões',
cardsWaitingLabel: 'cartões à espera', startQuiz: 'Iniciar questionário', testKnowledge: 'Testa o teu conhecimento',
addWord: 'Adicionar palavra', expandList: 'Amplia a tua lista', levelDistribution: 'Distribuição por nível', newLabel: 'Novas',
learningLabel: 'A aprender', learnedLabel: 'Aprendidas', recentWordsTitle: 'Palavras adicionadas recentemente', noWordsYet: 'Ainda não foram adicionadas palavras.',
newBadge: 'novo', dueTimeLabel: 'palavras prontas para rever', startBtn: 'Começar', dayLabels: 'Seg,Ter,Qua,Qui,Sex,Sáb,Dom',
statusLearned: 'Aprendida', statusLearning: 'A aprender', statusArchived: 'Arquivo', lookupNoMeaning: 'Nenhum significado encontrado. Podes inserir manualmente.',
lookupNotFound: 'Não encontrada no dicionário. Podes inserir manualmente.', lookupApplied: '✓ Significado adicionado ao formulário, podes editá-lo.',
meaningRequired: 'A palavra e o significado são obrigatórios.', saveFailed: 'Não foi possível guardar, tenta novamente.',
meaningRequiredLabel: 'Significado *', meaningNativeTpl: 'Significado em {lang}', meaningTargetTpl: 'Descrição em {lang}',
exampleLabel: 'Frase de exemplo', wordTypeLabel: 'Tipo de palavra', wordRequiredLabel: 'Palavra *', searchBtn: 'Pesquisar',
searchTooltip: 'Pesquisar no dicionário', lookupHelper: 'Escreve a palavra e prime Enter ou clica em Pesquisar — o significado preenche-se automaticamente.',
meaningsFoundTpl: '{n} significados encontrados para "{word}" — escolhe um:', listLabel: 'Lista', listActive: 'Ativa',
listPassive: 'Passiva', cancelBtn: 'Cancelar', savingBtn: 'A guardar…', saveBtn: 'Guardar', totalWordsCountTpl: '{n} palavras no total',
addWordBtn: 'Adicionar Palavra', learnedWordsLabel: 'Aprendidas', archivedWordsLabel: 'Arquivadas', searchPlaceholder: 'Pesquisar palavras…',
allStatuses: 'Todos os estados', allLists: 'Todas as listas', statusArchivedOption: 'Arquivada', noWordsFound: 'Nenhuma palavra encontrada',
noWordsFoundSub: 'Muda os filtros ou adiciona uma nova palavra.', colWord: 'Palavra', colMeaning: 'Significado', colType: 'Tipo',
colStatus: 'Estado', colRepeat: 'Repet.', colNext: 'Seguinte', deleteWordConfirm: 'Tens a certeza de que queres eliminar esta palavra?',
paginationTpl: '{n} palavras · Página {page} de {pages}', prevPage: '← Anterior', nextPage: 'Seguinte →', addWordModalTitle: 'Adicionar Nova Palavra',
editWordModalTitle: 'Editar Palavra', sessionComplete: 'Sessão Concluída!', reviewedCountTpl: '{n} palavras revistas',
correctLabel: 'Correto', wrongLabel: 'Incorreto', successRate: 'Taxa de sucesso', restartBtn: 'Recomeçar', wordsLoadError: 'Não foi possível carregar as palavras.',
greatJob: 'Bom trabalho!', noWordsDue: 'Não tens palavras para rever hoje.', noWordsYetTitle: 'Ainda não tens palavras', noWordsYetSubtitle: 'Adiciona algumas palavras ou joga primeiro — as palavras que acertares são adicionadas automaticamente ao teu tesouro.', tapToFlip: 'Toca para virar', listenBtn: 'Ouvir', exampleHeader: 'Exemplo',
dontKnowBtn: 'Não sabia', knewItBtn: 'Sabia', correctCountTpl: '{n} corretas', wrongCountTpl: '{n} incorretas', tierExcellent: 'Excelente!',
tierGood: 'Bom Trabalho!', tierKeepGoing: 'Continua Assim!', questionsCompletedTpl: 'Completaste {n} perguntas', retryQuizBtn: 'Repetir Questionário',
quizMinWordsError: 'Precisas de pelo menos 4 palavras para um questionário. Adiciona algumas palavras primeiro.',
quizQuestionPrompt: 'O que significa esta palavra?', questionCounterTpl: 'Pergunta {i}/{n}', scheduleTitle: 'Horário de Estudo',
activeDaysStatsTpl: '{days} dias ativos · {items} atividades', saveAsTemplateBtn: 'Guardar como Modelo', templatesBtn: 'Modelos',
addActivityBtn: 'Adicionar Atividade', manualAddBtn: 'Adicionar Manualmente', chooseTemplateBtn: 'Escolher Modelo',
noScheduleYet: 'Ainda não há horário', noScheduleYetSub: 'Começa rapidamente com um modelo pronto ou adiciona as tuas próprias atividades.',
noActivity: 'Sem atividade', toggleTooltip: 'Alternar', deleteScheduleConfirm: 'Tens a certeza de que queres eliminar este item do horário?',
deleteTemplateConfirm: 'Tens a certeza de que queres eliminar este modelo personalizado?', templatesModalTitle: 'Modelos de Horário Prontos',
templatesModalDesc: 'Escolhe um modelo com base na tua frequência de estudo ou área de foco — o horário é criado automaticamente e depois podes editá-lo como quiseres.',
replaceExistingLabel: 'Eliminar o horário atual e substituir pelo modelo', perWeekTpl: '{n} atividades / semana',
applyBtn: 'Aplicar', myTemplatesLabel: 'Os Meus Modelos', noCustomTemplates: 'Ainda não tens o teu próprio modelo. Cria um horário e guarda-o aqui com "Guardar como Modelo".',
deleteTemplateTooltip: 'Eliminar modelo', addActivityModalTitle: 'Adicionar Atividade', dayLabel: 'Dia', timeLabel: 'Hora',
durationLabel: 'Duração (min)', activityLabel: 'Atividade *', linkLabel: 'Link (opcional)', activityRequired: 'A atividade é obrigatória.',
saveScheduleFailed: 'Não foi possível guardar.', saveTemplateModalTitle: 'Guardar como Modelo', saveTemplateDesc: 'Guarda o teu horário atual como um modelo com nome que podes voltar a aplicar quando quiseres.',
templateNameLabel: 'Nome do modelo *', templateNameRequired: 'O nome do modelo é obrigatório.', saveTemplateFailed: 'Não foi possível guardar o modelo.',
weekdayLabels: 'Domingo,Segunda,Terça,Quarta,Quinta,Sexta,Sábado',
exportPdfBtn: 'Baixar PDF', exportModalTitle: 'Baixar o programa em PDF',
exportModalDesc: 'Escolha um design — imprima e mantenha na sua mesa ou pendure em algum lugar.',
exportEmptyMsg: 'Crie primeiro um programa de estudo (aplique um modelo ou adicione uma atividade manualmente) e depois você poderá exportá-lo como PDF.',
exportGeneratingBtn: 'Gerando…', exportDownloadBtn: 'Baixar PDF', exportPdfFailed: 'Não foi possível gerar o PDF, tente novamente.',
brandHeadlineLine1: 'A forma mais inteligente',
brandHeadlineLine2: 'de aprender vocabulário', brandSubtitle: 'Revê apenas no momento certo com repetição espaçada. Estuda menos, aprende mais.',
statAlgorithmLabel: 'Algoritmo', statLanguagesLabel: 'Idiomas Suportados', statLanguagesValue: 'Multilíngue', statPlanLabel: 'Plano',
statPlanValue: 'Freemium', copyrightTpl: '© {year} Lexis. Todos os direitos reservados.', interfaceLanguageLabel: 'Idioma da interface',
loginTitle: 'Iniciar sessão no Lexis', emailLabel: 'E-mail', passwordLabel: 'Palavra-passe', loginErrorMsg: 'Não foi possível iniciar sessão. Verifica os teus dados.',
loggingInBtn: 'A iniciar sessão…', loginBtnText: 'Iniciar Sessão', noAccountQuestion: 'Não tens conta?', registerLinkText: 'Regista-te',
registerTitleText: 'Criar conta', registerSubtitleText: 'Começa em segundos.', fullNameLabel: 'Nome completo', usernameLabel: 'Nome de utilizador',
passwordHintText: 'Pelo menos 6 carateres', nativeLangSelectLabel: 'O teu idioma nativo', learningLangSelectLabel: 'Idioma que queres aprender',
emailInvalidError: 'Introduz um e-mail válido.', usernameMinError: 'Deve ter pelo menos 3 carateres.', passwordMinError: 'Deve ter pelo menos 6 carateres.',
sameLangError: 'O idioma que queres aprender tem de ser diferente do teu idioma nativo.', registerFailedGeneric: 'O registo falhou. Este e-mail já pode estar em uso.',
createAccountBtn: 'Criar Conta', haveAccountQuestion: 'Já tens conta?', loginLinkText: 'Iniciar sessão', forgotPasswordLink: 'Esqueceste-te da palavra-passe?', sessionExpiredNotice: 'Parece que a tua sessão expirou.', backToPageBtn: 'Voltar à página',
typeNoun: 'Substantivo', typeVerb: 'Verbo', typeAdjective: 'Adjetivo', typeAdverb: 'Advérbio', typePhrasalVerb: 'Verbo Frasal',
typeIdiom: 'Expressão Idiomática', typePhrase: 'Frase', typeOther: 'Outro', statsLoadError: 'Não foi possível carregar as estatísticas.',
statsPageTitle: 'Estatísticas', statsPageSubtitle: 'A tua jornada de aprendizagem num relance', noDataYet: 'Ainda não há dados',
noDataYetSub: 'Assim que adicionares palavras e começares a estudar, os gráficos ganham vida aqui.', longestStreak: 'Sequência Mais Longa',
streakDaysAbbrTpl: '{n}d', statusDistribution: 'Distribuição por Estado', statusDistributionSub: 'Estado de aprendizagem das tuas palavras',
learnedPercentLabel: 'aprendido', typeByLearnRate: 'Taxa de Aprendizagem por Tipo de Palavra', typeByLearnRateSub: 'Em que tipo és mais forte? (%)',
learnRateTooltip: 'Taxa de aprendizagem', typeDistribution: 'Distribuição por Tipo de Palavra', typeDistributionSub: 'Número de palavras por tipo',
wordTooltip: 'Palavra', learningSpeed: 'Velocidade de Aprendizagem', learningSpeedSub: 'Repetições médias por tipo — menos = mais rápido',
repeatUnitTpl: '{n} repetições', averageTooltip: 'Média', last30DaysTitle: 'Últimos 30 Dias — Palavras Adicionadas',
last30DaysSub: 'O teu ritmo diário de adicionar palavras', addedWordUnitTpl: '{n} palavras', addedTooltip: 'Adicionadas',
studyActivity: 'Atividade de Estudo', studyActivitySub: 'Adicionadas vs. revistas por dia', addedLegend: 'Adicionadas',
repeatLegend: 'Revistas', profileLoadError: 'Não foi possível carregar a informação do perfil.', displayNameLabel: 'Nome apresentado',
emailChangeHint: 'Se alterares o teu e-mail, o Supabase pode enviar um e-mail de verificação.', newPasswordLabel: 'Nova palavra-passe',
newPasswordPlaceholder: 'Deixa em branco se não quiseres alterá-la', dailyGoalLabel: 'Meta diária de palavras', savedLabel: 'Guardado',
accountInfoTitle: 'Informação da Conta', roleLabel: 'Função', memberSinceLabel: 'Membro desde', myLanguagesTitle: 'Os Meus Idiomas',
addLanguageBtn: 'Adicionar Idioma', addLanguageModalTitle: 'Adicionar Idioma de Aprendizagem', selectLanguageLabel: 'Seleciona um idioma',
setActiveBtn: 'Ativar', activeBadgeLabel: 'Ativo', removeLanguageBtn: 'Remover', removeLanguageConfirm: 'Tens a certeza de que queres remover este idioma da tua lista?',
cannotRemoveActiveLanguageError: 'Não podes remover o idioma ativo. Ativa antes outro idioma.', languageAlreadyAddedError: 'Este idioma já está na tua lista.',
...
premiumCheckoutStartError: 'Não foi possível iniciar o pagamento, tenta novamente.', premiumCancelConfirm: 'Tens a certeza de que queres cancelar a tua subscrição? O teu acesso premium continua até ao final do período.',
premiumCancelError: 'Não foi possível cancelar a subscrição.', premiumSuccessMsg: 'O teu pagamento foi recebido, a tua adesão premium já está ativa 🎉',
premiumFailedMsg: 'Não foi possível concluir o pagamento. Podes tentar novamente.', premiumPeriodEndTpl: 'Fim do período: {date}',
