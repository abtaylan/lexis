...
createAccountBtn: 'アカウントを作成', haveAccountQuestion: 'すでにアカウントをお持ちの方', loginLinkText: 'ログイン', forgotPasswordLink: 'パスワードをお忘れですか？',
...
createAccountBtn: 'Criar Conta', haveAccountQuestion: 'Já tens conta?', loginLinkText: 'Iniciar sessão', forgotPasswordLink: 'Esqueceste-te da palavra-passe?',
