...
noWordsDue: '今日復習する単語はありません。', tapToFlip: 'タップして裏返す', exampleHeader: '例文',
...
greatJob: 'Bom trabalho!', noWordsDue: 'Não tens palavras para rever hoje.', tapToFlip: 'Toca para virar', exampleHeader: 'Exemplo',
