...
noWordsDue: 'Bugün için tekrar edilecek kelimen yok.', noWordsYetTitle: 'Henüz kelimen yok', noWordsYetSubtitle: 'Kartlarla çalışmak için önce birkaç kelime ekle ya da bir oyun oyna — doğru bildiğin kelimeler otomatik olarak hazineye eklenir.', tapToFlip: 'Çevirmek için tıkla', exampleHeader: 'Örnek',
...
noWordsDue: 'You have no words due for review today.', noWordsYetTitle: 'You don\'t have any words yet', noWordsYetSubtitle: 'Add a few words or play a game first — words you get right are added to your treasury automatically.', tapToFlip: 'Tap to flip', exampleHeader: 'Example',
...
noWordsDue: 'لا توجد كلمات للمراجعة اليوم.', noWordsYetTitle: 'ليس لديك كلمات بعد', noWordsYetSubtitle: 'أضف بعض الكلمات أو العب إحدى الألعاب أولاً — الكلمات التي تجيب عنها بشكل صحيح تُضاف تلقائيًا إلى مخزونك.', tapToFlip: 'انقر للقلب', exampleHeader: 'مثال',
...
noWordsDue: 'На сегодня нет слов для повторения.', noWordsYetTitle: 'У вас пока нет слов', noWordsYetSubtitle: 'Сначала добавьте несколько слов или сыграйте в игру — слова, которые вы угадаете правильно, автоматически добавляются в вашу коллекцию.', tapToFlip: 'Нажми, чтобы перевернуть', exampleHeader: 'Пример',
...
noWordsDue: "Tu n'as aucun mot à réviser aujourd'hui.", noWordsYetTitle: 'Tu n\'as pas encore de mots', noWordsYetSubtitle: 'Ajoute quelques mots ou joue à un jeu d\'abord — les mots que tu trouves juste sont ajoutés automatiquement à ton trésor.', tapToFlip: 'Touche pour retourner', exampleHeader: 'Exemple',
...
noWordsDue: 'No tienes palabras para repasar hoy.', noWordsYetTitle: 'Todavía no tienes palabras', noWordsYetSubtitle: 'Añade algunas palabras o juega primero — las palabras que aciertas se añaden automáticamente a tu tesoro.', tapToFlip: 'Toca para voltear', exampleHeader: 'Ejemplo',
...
noWordsDue: 'Non hai parole da ripassare oggi.', noWordsYetTitle: 'Non hai ancora parole', noWordsYetSubtitle: 'Aggiungi prima qualche parola o gioca — le parole che indovini vengono aggiunte automaticamente al tuo tesoro.', tapToFlip: 'Tocca per girare', exampleHeader: 'Esempio',
...
noWordsDue: '今日復習する単語はありません。', noWordsYetTitle: 'まだ単語がありません', noWordsYetSubtitle: 'まず単語を追加するかゲームをプレイしてください — 正解した単語は自動的にあなたの単語帳に追加されます。', tapToFlip: 'タップして裏返す', exampleHeader: '例文',
...
greatJob: 'Bom trabalho!', noWordsDue: 'Não tens palavras para rever hoje.', noWordsYetTitle: 'Ainda não tens palavras', noWordsYetSubtitle: 'Adiciona algumas palavras ou joga primeiro — as palavras que acertares são adicionadas automaticamente ao teu tesouro.', tapToFlip: 'Toca para virar', exampleHeader: 'Exemplo',
