...
const dictionaries: Record<Locale, Dictionary> = {
  tr: {
    ...
    lookupNoMeaning: 'Anlam bulunamadı. Elle girebilirsin.',
    lookupNotFound: 'Sözlükte bulunamadı. Elle girebilirsin.',
    lookupApplied: '✓ Anlam forma eklendi, düzenleyebilirsin.',
    meaningRequired: 'Kelime ve anlam zorunludur.',
    saveFailed: 'Kaydedilemedi, tekrar deneyin.',
    meaningRequiredLabel: 'Anlam *',
    meaningNativeTpl: '{lang} anlamı',
    meaningTargetTpl: '{lang} açıklaması',
    exampleLabel: 'Örnek cümle',
    wordTypeLabel: 'Kelime türü',
    wordRequiredLabel: 'Kelime *',
    searchBtn: 'Ara',
    searchTooltip: 'Sözlükte ara',
    lookupHelper: 'Kelimeyi yazıp Enter’a bas veya Ara’ya tıkla — anlamı otomatik gelir.',
    meaningsFoundTpl: '"{word}" için {n} anlam — birini seç:',
    listLabel: 'Liste',
    listActive: 'Aktif',
    listPassive: 'Pasif',
    cancelBtn: 'İptal',
    ...
    saveBtn: 'Kaydet',
    totalWordsCountTpl: 'Toplam {n} kelime',
    addWordBtn: 'Kelime Ekle',
    learnedWordsLabel: 'Öğrenilenler',
    archivedWordsLabel: 'Arşivlenenler',
    searchPlaceholder: 'Kelime ara…',
    allStatuses: 'Tüm durumlar',
    allLists: 'Tüm listeler',
    statusArchivedOption: 'Arşivlendi',
    noWordsFound: 'Kelime bulunamadı',
    noWordsFoundSub: 'Filtreleri değiştir veya yeni kelime ekle.',
    colWord: 'Kelime',
    colMeaning: 'Anlam',
    colType: 'Tür',
    colStatus: 'Durum',
    colRepeat: 'Tekrar',
    colNext: 'Sonraki',
    deleteWordConfirm: 'Bu kelimeyi silmek istediğine emin misin?',
    paginationTpl: '{n} kelime · Sayfa {page} / {pages}',
    prevPage: '← Önceki',
    nextPage: 'Sonraki →',
    addWordModalTitle: 'Yeni Kelime Ekle',
    editWordModalTitle: 'Kelimeyi Düzenle',
  },
  en: {
    dashboard: 'Dashboard',
    words: 'Words',
    ...
    lookupNoMeaning: 'No meaning found. You can enter it manually.',
    lookupNotFound: 'Not found in dictionary. You can enter it manually.',
    lookupApplied: '✓ Meaning added to form, you can edit it.',
    meaningRequired: 'Word and meaning are required.',
    saveFailed: 'Could not save, please try again.',
    meaningRequiredLabel: 'Meaning *',
    meaningNativeTpl: '{lang} meaning',
    meaningTargetTpl: '{lang} description',
    exampleLabel: 'Example sentence',
    wordTypeLabel: 'Word type',
    wordRequiredLabel: 'Word *',
    searchBtn: 'Search',
    searchTooltip: 'Search dictionary',
    lookupHelper: 'Type the word and press Enter or click Search — the meaning fills in automatically.',
    meaningsFoundTpl: '{n} meanings found for "{word}" — pick one:',
    listLabel: 'List',
    listActive: 'Active',
    listPassive: 'Passive',
    cancelBtn: 'Cancel',
    savingBtn: 'Saving…',
    saveBtn: 'Save',
    totalWordsCountTpl: '{n} words total',
    addWordBtn: 'Add Word',
    learnedWordsLabel: 'Learned',
    archivedWordsLabel: 'Archived',
    searchPlaceholder: 'Search words…',
    allStatuses: 'All statuses',
    allLists: 'All lists',
    statusArchivedOption: 'Archived',
    noWordsFound: 'No words found',
    noWordsFoundSub: 'Change the filters or add a new word.',
    colWord: 'Word',
    colMeaning: 'Meaning',
    colType: 'Type',
    colStatus: 'Status',
    ...
    paginationTpl: '{n} words · Page {page} of {pages}',
    prevPage: '← Previous',
    nextPage: 'Next →',
    addWordModalTitle: 'Add New Word',
    editWordModalTitle: 'Edit Word',
  },
  ar: {
    ...
    statusLearned: 'تم تعلمه',
    statusLearning: 'قيد التعلم',
    statusArchived: 'أرشيف',
    lookupNoMeaning: 'لم يُعثر على معنى. يمكنك إدخاله يدويًا.',
    lookupNotFound: 'غير موجود في القاموس. يمكنك إدخاله يدويًا.',
    lookupApplied: '✓ تمت إضافة المعنى إلى النموذج، يمكنك تعديله.',
    meaningRequired: 'الكلمة والمعنى مطلوبان.',
    saveFailed: 'تعذر الحفظ، حاول مجددًا.',
    meaningRequiredLabel: 'المعنى *',
    meaningNativeTpl: 'معنى {lang}',
    meaningTargetTpl: 'شرح {lang}',
    exampleLabel: 'جملة مثال',
    wordTypeLabel: 'نوع الكلمة',
    wordRequiredLabel: 'الكلمة *',
    searchBtn: 'بحث',
    searchTooltip: 'ابحث في القاموس',
    lookupHelper: 'اكتب الكلمة واضغط Enter أو انقر بحث — سيظهر المعنى تلقائيًا.',
    meaningsFoundTpl: '{n} معنى لـ"{word}" — اختر واحدًا:',
    listLabel: 'القائمة',
    listActive: 'نشط',
    listPassive: 'غير نشط',
    cancelBtn: 'إلغاء',
    ...
    saveBtn: 'حفظ',
    totalWordsCountTpl: 'إجمالي {n} كلمة',
    addWordBtn: 'إضافة كلمة',
    learnedWordsLabel: 'المتعلمة',
    archivedWordsLabel: 'المؤرشفة',
    searchPlaceholder: 'ابحث عن كلمة…',
    allStatuses: 'كل الحالات',
    allLists: 'كل القوائم',
    statusArchivedOption: 'مؤرشف',
    noWordsFound: 'لم يُعثر على كلمات',
    noWordsFoundSub: 'غيّر الفلاتر أو أضف كلمة جديدة.',
    colWord: 'الكلمة',
    colMeaning: 'المعنى',
    colType: 'النوع',
    colStatus: 'الحالة',
    colRepeat: 'التكرار',
    colNext: 'التالي',
    deleteWordConfirm: 'هل أنت متأكد من حذف هذه الكلمة؟',
    paginationTpl: '{n} كلمة · صفحة {page} من {pages}',
    prevPage: '← السابق',
    nextPage: 'التالي →',
    addWordModalTitle: 'إضافة كلمة جديدة',
    editWordModalTitle: 'تعديل الكلمة',
  },
  ru: {
    dashboard: 'Панель',
    words: 'Слова',
    ...
    lookupNoMeaning: 'Значение не найдено. Можно ввести вручную.',
    lookupNotFound: 'Не найдено в словаре. Можно ввести вручную.',
    lookupApplied: '✓ Значение добавлено в форму, можно отредактировать.',
    meaningRequired: 'Слово и значение обязательны.',
    saveFailed: 'Не удалось сохранить, попробуйте снова.',
    meaningRequiredLabel: 'Значение *',
    meaningNativeTpl: 'Значение на {lang}',
    meaningTargetTpl: 'Описание на {lang}',
    exampleLabel: 'Пример предложения',
    wordTypeLabel: 'Часть речи',
    wordRequiredLabel: 'Слово *',
    searchBtn: 'Найти',
    searchTooltip: 'Поиск в словаре',
    lookupHelper: 'Введите слово и нажмите Enter или «Найти» — значение подставится автоматически.',
    meaningsFoundTpl: 'Найдено {n} значений для «{word}» — выберите:',
    listLabel: 'Список',
    listActive: 'Активный',
    listPassive: 'Пассивный',
    cancelBtn: 'Отмена',
    savingBtn: 'Сохранение…',
    saveBtn: 'Сохранить',
    totalWordsCountTpl: 'Всего {n} слов',
    addWordBtn: 'Добавить слово',
    learnedWordsLabel: 'Изучено',
    archivedWordsLabel: 'В архиве',
    searchPlaceholder: 'Поиск слов…',
    allStatuses: 'Все статусы',
    allLists: 'Все списки',
    statusArchivedOption: 'В архиве',
    noWordsFound: 'Слова не найдены',
    noWordsFoundSub: 'Измените фильтры или добавьте новое слово.',
    colWord: 'Слово',
    colMeaning: 'Значение',
    colType: 'Тип',
    colStatus: 'Статус',
    colRepeat: 'Повторы',
    colNext: 'Далее',
    deleteWordConfirm: 'Уверены, что хотите удалить это слово?',
    paginationTpl: '{n} слов · Страница {page} из {pages}',
    prevPage: '← Назад',
    nextPage: 'Вперёд →',
    addWordModalTitle: 'Добавить новое слово',
    editWordModalTitle: 'Редактировать слово',
  },
  de: {
    dashboard: 'Dashboard',
    words: 'Wörter',
    ...
    statusLearning: 'Wird gelernt',
    statusArchived: 'Archiv',
    lookupNoMeaning: 'Keine Bedeutung gefunden. Du kannst sie manuell eingeben.',
    lookupNotFound: 'Nicht im Wörterbuch gefunden. Du kannst sie manuell eingeben.',
    lookupApplied: '✓ Bedeutung wurde übernommen, du kannst sie bearbeiten.',
    meaningRequired: 'Wort und Bedeutung sind erforderlich.',
    saveFailed: 'Konnte nicht gespeichert werden, versuche es erneut.',
    meaningRequiredLabel: 'Bedeutung *',
    meaningNativeTpl: 'Bedeutung auf {lang}',
    meaningTargetTpl: 'Beschreibung auf {lang}',
    exampleLabel: 'Beispielsatz',
    wordTypeLabel: 'Wortart',
    wordRequiredLabel: 'Wort *',
    searchBtn: 'Suchen',
    searchTooltip: 'Im Wörterbuch suchen',
    lookupHelper: 'Wort eingeben und Enter drücken oder auf Suchen klicken — die Bedeutung wird automatisch übernommen.',
    meaningsFoundTpl: '{n} Bedeutungen für „{word}“ gefunden — wähle eine aus:',
    listLabel: 'Liste',
    listActive: 'Aktiv',
    listPassive: 'Passiv',
    cancelBtn: 'Abbrechen',
    ...
    saveBtn: 'Speichern',
    totalWordsCountTpl: '{n} Wörter insgesamt',
    addWordBtn: 'Wort hinzufügen',
    learnedWordsLabel: 'Gelernt',
    archivedWordsLabel: 'Archiviert',
    searchPlaceholder: 'Wörter suchen…',
    allStatuses: 'Alle Status',
    allLists: 'Alle Listen',
    statusArchivedOption: 'Archiviert',
    noWordsFound: 'Keine Wörter gefunden',
    noWordsFoundSub: 'Filter ändern oder neues Wort hinzufügen.',
    colWord: 'Wort',
    ...
    colRepeat: 'Wdh.',
    colNext: 'Nächste',
    deleteWordConfirm: 'Möchtest du dieses Wort wirklich löschen?',
    paginationTpl: '{n} Wörter · Seite {page} von {pages}',
    prevPage: '← Zurück',
    nextPage: 'Weiter →',
    addWordModalTitle: 'Neues Wort hinzufügen',
    editWordModalTitle: 'Wort bearbeiten',
  },
  fr: {
    ...
    statusArchived: 'Archive',
    lookupNoMeaning: 'Aucune signification trouvée. Tu peux la saisir manuellement.',
    lookupNotFound: 'Introuvable dans le dictionnaire. Tu peux la saisir manuellement.',
    lookupApplied: '✓ Signification ajoutée au formulaire, tu peux la modifier.',
    meaningRequired: 'Le mot et la signification sont obligatoires.',
    saveFailed: "Impossible d'enregistrer, réessaie.",
    meaningRequiredLabel: 'Signification *',
    meaningNativeTpl: 'Signification en {lang}',
    meaningTargetTpl: 'Description en {lang}',
    exampleLabel: 'Phrase d’exemple',
    wordTypeLabel: 'Type de mot',
    wordRequiredLabel: 'Mot *',
    searchBtn: 'Chercher',
    searchTooltip: 'Chercher dans le dictionnaire',
    lookupHelper: "Tape le mot et appuie sur Entrée ou clique sur Chercher — la signification se remplit automatiquement.",
    meaningsFoundTpl: '{n} significations trouvées pour « {word} » — choisis-en une :',
    listLabel: 'Liste',
    listActive: 'Active',
    listPassive: 'Passive',
    cancelBtn: 'Annuler',
    ...
    saveBtn: 'Enregistrer',
    totalWordsCountTpl: '{n} mots au total',
    addWordBtn: 'Ajouter un mot',
    learnedWordsLabel: 'Appris',
    archivedWordsLabel: 'Archivés',
    searchPlaceholder: 'Rechercher des mots…',
    allStatuses: 'Tous les statuts',
    allLists: 'Toutes les listes',
    statusArchivedOption: 'Archivé',
    noWordsFound: 'Aucun mot trouvé',
    noWordsFoundSub: 'Modifie les filtres ou ajoute un nouveau mot.',
    colWord: 'Mot',
    ...
    colRepeat: 'Répét.',
    colNext: 'Suivant',
    deleteWordConfirm: 'Es-tu sûr de vouloir supprimer ce mot ?',
    paginationTpl: '{n} mots · Page {page} sur {pages}',
    prevPage: '← Précédent',
    nextPage: 'Suivant →',
    addWordModalTitle: 'Ajouter un nouveau mot',
    editWordModalTitle: 'Modifier le mot',
  },
  es: {
    dashboard: 'Panel',
    words: 'Palabras',
    ...
    statusLearned: 'Aprendida',
    statusLearning: 'Aprendiendo',
    statusArchived: 'Archivo',
    lookupNoMeaning: 'No se encontró significado. Puedes introducirlo manualmente.',
    lookupNotFound: 'No se encontró en el diccionario. Puedes introducirlo manualmente.',
    lookupApplied: '✓ Significado añadido al formulario, puedes editarlo.',
    meaningRequired: 'La palabra y el significado son obligatorios.',
    saveFailed: 'No se pudo guardar, inténtalo de nuevo.',
    meaningRequiredLabel: 'Significado *',
    meaningNativeTpl: 'Significado en {lang}',
    meaningTargetTpl: 'Descripción en {lang}',
    exampleLabel: 'Frase de ejemplo',
    wordTypeLabel: 'Tipo de palabra',
    wordRequiredLabel: 'Palabra *',
    searchBtn: 'Buscar',
    searchTooltip: 'Buscar en el diccionario',
    lookupHelper: 'Escribe la palabra y pulsa Enter o haz clic en Buscar — el significado se rellena automáticamente.',
    meaningsFoundTpl: '{n} significados encontrados para "{word}" — elige uno:',
    listLabel: 'Lista',
    listActive: 'Activa',
    listPassive: 'Pasiva',
    cancelBtn: 'Cancelar',
    savingBtn: 'Guardando…',
    saveBtn: 'Guardar',
    totalWordsCountTpl: '{n} palabras en total',
    addWordBtn: 'Añadir palabra',
    learnedWordsLabel: 'Aprendidas',
    archivedWordsLabel: 'Archivadas',
    searchPlaceholder: 'Buscar palabras…',
    allStatuses: 'Todos los estados',
    allLists: 'Todas las listas',
    statusArchivedOption: 'Archivada',
    noWordsFound: 'No se encontraron palabras',
    noWordsFoundSub: 'Cambia los filtros o añade una nueva palabra.',
    colWord: 'Palabra',
    ...
    colRepeat: 'Repet.',
    colNext: 'Siguiente',
    deleteWordConfirm: '¿Seguro que quieres eliminar esta palabra?',
    paginationTpl: '{n} palabras · Página {page} de {pages}',
    prevPage: '← Anterior',
    nextPage: 'Siguiente →',
    addWordModalTitle: 'Añadir nueva palabra',
    editWordModalTitle: 'Editar palabra',
  },
  it: {
    dashboard: 'Dashboard',
    words: 'Parole',
    ...
    statusLearned: 'Appresa',
    statusLearning: 'In apprendimento',
    statusArchived: 'Archivio',
    lookupNoMeaning: 'Nessun significato trovato. Puoi inserirlo manualmente.',
    lookupNotFound: 'Non trovato nel dizionario. Puoi inserirlo manualmente.',
    lookupApplied: '✓ Significato aggiunto al modulo, puoi modificarlo.',
    meaningRequired: 'Parola e significato sono obbligatori.',
    saveFailed: 'Impossibile salvare, riprova.',
    meaningRequiredLabel: 'Significato *',
    meaningNativeTpl: 'Significato in {lang}',
    meaningTargetTpl: 'Descrizione in {lang}',
    exampleLabel: 'Frase di esempio',
    wordTypeLabel: 'Tipo di parola',
    wordRequiredLabel: 'Parola *',
    searchBtn: 'Cerca',
    searchTooltip: 'Cerca nel dizionario',
    lookupHelper: 'Scrivi la parola e premi Invio o clicca su Cerca — il significato si compila automaticamente.',
    meaningsFoundTpl: '{n} significati trovati per "{word}" — scegline uno:',
    listLabel: 'Elenco',
    listActive: 'Attivo',
    listPassive: 'Passivo',
    cancelBtn: 'Annulla',
    ...
    saveBtn: 'Salva',
    totalWordsCountTpl: '{n} parole in totale',
    addWordBtn: 'Aggiungi parola',
    learnedWordsLabel: 'Apprese',
    archivedWordsLabel: 'Archiviate',
    searchPlaceholder: 'Cerca parole…',
    allStatuses: 'Tutti gli stati',
    allLists: 'Tutti gli elenchi',
    statusArchivedOption: 'Archiviata',
    noWordsFound: 'Nessuna parola trovata',
    noWordsFoundSub: 'Cambia i filtri o aggiungi una nuova parola.',
    colWord: 'Parola',
    ...
    colRepeat: 'Ripet.',
    colNext: 'Prossima',
    deleteWordConfirm: 'Sei sicuro di voler eliminare questa parola?',
    paginationTpl: '{n} parole · Pagina {page} di {pages}',
    prevPage: '← Precedente',
    nextPage: 'Successiva →',
    addWordModalTitle: 'Aggiungi nuova parola',
    editWordModalTitle: 'Modifica parola',
  },
};
