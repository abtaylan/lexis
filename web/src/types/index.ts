...
// bkz. backend/app/api/routes/referrals.py GET /me
...
// 18 Eylul 2026 -- 'placement' EXAM_TYPE_ORDER (exam-prep/page.tsx) gibi
...
// words.py::WordOfTheDayResponse). found=false iken diger alanlar yoktur --
// widget bu durumda sessizce hic render edilmez.
...
// 18 Eylul 2026 -- GET /exams/placement/status yaniti (bkz. dashboard/page.tsx'teki
...
// (arkadaslardan + sistemdeki diger kullanicilardan olusan, kademe
// (tier) liglerinden BAGIMSIZ, haftalik donguye TABI OLMAYAN kucuk
// lig). Backend: backend/app/schemas/custom_leagues.py ile BIREBIR
// ayni alanlar.
// ============================================================
