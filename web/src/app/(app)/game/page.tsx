...
const STRINGS: Record<Locale, Strings> = {
  tr: {
    ...
    dirDefinitionToWordDesc: 'Tanımı gör, doğru kelimeyi seç (en zor, en çok XP)',
  ...
  en: {
    ...
    dirDefinitionToWordDesc: 'See the definition, pick the right word (hardest, most XP)',
  ...
  ar: {
    ...
    dirDefinitionToWordDesc: 'شاهد التعريف، اختر الكلمة الصحيحة (الأصعب، أكثر خبرة)',
  ...
  ru: {
    ...
    dirDefinitionToWordDesc: 'Смотри определение, выбирай правильное слово (сложнее всего, больше всего опыта)',
  ...
  de: {
    ...
    dirDefinitionToWordDesc: 'Sieh die Definition, wähle das richtige Wort (am schwersten, meiste XP)',
  ...
  fr: {
    ...
    dirDefinitionToWordDesc: 'Vois la définition, choisis le bon mot (le plus difficile, le plus de XP)',
  ...
  es: {
    ...
    dirDefinitionToWordDesc: 'Ve la definición, elige la palabra correcta (más difícil, más XP)',
  ...
  it: {
    ...
    dirDefinitionToWordDesc: 'Vedi la definizione, scegli la parola corretta (più difficile, più XP)',
  ...
  ja: {
    ...
    dirDefinitionToWordDesc: '定義を見て正しい単語を選ぶ(最も難しい、獲得XP最大)',
  ...
  pt: {
    ...
    dirDefinitionToWordDesc: 'Vê a definição, escolhe a palavra certa (o mais difícil, o mais XP)',
